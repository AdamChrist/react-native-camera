...
public class RNCameraView extends CameraView implements LifecycleEventListener, BarCodeScannerAsyncTaskDelegate, FaceDetectorAsyncTaskDelegate,
        BarcodeDetectorAsyncTaskDelegate, TextRecognizerAsyncTaskDelegate, PictureSavedDelegate, TFObjectDetectAsyncTaskDelegate {
    ...
    public volatile boolean TFObjectDetectorTaskLock = false;
    ...
    private boolean mShouldTFObjectDetect = false;
    ...
    private Classifier tfDetector;
    private TFOptions tfOptions;
    ...
    public RNCameraView(ThemedReactContext themedReactContext) {
        ...
        addCallback(new Callback() {
            ...
            public void onFramePreview(CameraView cameraView, byte[] data, int width, int height, int rotation) {
                ...
                boolean willCallTFObjectDetectTask = mShouldTFObjectDetect && !TFObjectDetectorTaskLock && cameraView instanceof TFObjectDetectAsyncTaskDelegate;
                if (!willCallBarCodeTask && !willCallFaceTask && !willCallGoogleBarcodeTask && !willCallTextTask && !willCallTFObjectDetectTask) {
                    return;
                }
                ...
                if (willCallTFObjectDetectTask) {
                    TFObjectDetectorTaskLock = true;
                    TFObjectDetectAsyncTaskDelegate delegate = (TFObjectDetectAsyncTaskDelegate) cameraView;
                    new TFObjectDetectScannerAsyncTask(delegate, data, width, height, correctRotation, tfOptions, tfDetector).execute();
                }
            }
        });
    }
    ...
    public void setTFOptions(TFOptions options) {
    ...
    @Override
    public void onTFObjectDetect(WritableArray results) {
        if (!mShouldTFObjectDetect) {
            return;
        }
        RNCameraViewHelper.emitTFObjectDetectedEvent(this, results);
    }

    @Override
    public void onTFObjectDetectTaskCompleted() {
        TFObjectDetectorTaskLock = false;
    }
}
